...
a &= 1.54. 
\end{align*}
So we can reasonably conclude that the complexity of Wiener and Regularisation is in $\mathcal{O}(n\sqrt{n})$, the black line at the figure~\ref{fig:ComplexityRelbw} . 
