...
%   $Revision: 5.27.4.3 $  $Date: 2004/08/10 01:46:28 $

iptchecknargin(1, 3, nargin, mfilename)
iptcheckinput(I,{'numeric','logical'},{'nonsparse'},mfilename,'I',1);

if (nargin < 2)
    theta = 0:179;
else
    %this is also checked by mex file
    iptcheckinput(theta,{'double'},{'nonsparse'},mfilename,'THETA',2); 
end

[P,r] = radon(double(I),theta);
