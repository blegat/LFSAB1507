...
\begin{figure}[h]
\centering
\includegraphics[{width=0.4 \textwidth}]{../Images/Camera/Human_walking/background-color/BGFinal.jpg}
...
and \figref{dontpanic_blue-40-0_2_1-100}.
...
\begin{myfig}{dontpanic}{Square image on real background blurred with $(40,\ang{0})$.}
  ...
  \begin{myfigsub}{dontpanic-g-40_0}
    {Wiener}{0.49}
    \includegraphics[trim=7cm 6cm 7cm 5cm,clip,width=\textwidth]{dontpanic-g-40_0.png}
  \end{myfigsub}
\end{myfig}

``exact-lucy'' has some problems to estimate the foreground
for \figref{dontpanic-40-0_2_2-20} and
\figref{dontpanic-40-0_2_2-100} since the background color
is quite close, they are both red.
For \figref{dontpanic_blue-40-0_2_2-20}
and \figref{dontpanic_blue-40-0_2_2-100} however,
...
\begin{myfig}{dontpanic_blue}{Square image on real background blurred with $(40,\ang{0})$.}
  ...
  \begin{myfigsub}{dontpanic_blue-g-40_0}
    {Wiener}{0.49}
    \includegraphics[trim=6cm 5cm 6cm 5cm,clip,width=\textwidth]{dontpanic_blue-g-40_0.png}
  \end{myfigsub}
\end{myfig}
...
\begin{myfig}{car2}{Car deblurred, real blur}
  ...
  \begin{myfigsub}{car2}
    {Initial blurred image}{0.49}
    \includegraphics[trim=18cm 4.5cm 7cm 15cm,clip,width=\textwidth]{car2.jpg}
  \end{myfigsub}
\end{myfig}
