...
However, this filter needs an estimation of the noise and image variances, which are difficult to estimate~\cite{mathWorksWiener}. For further details on this estimation, please refer to section \ref{sec:NSREstimation}.
