...
\begin{equation}
g(x,y) = \mathcal{H}\left\lbrace f(x,y) \right\lbrace.
\end{equation}
...
\begin{equation}
\mathcal{H}\left\lbrace \alpha f_1(x,y) + \beta f_2(x,y) \right\lbrace =  \alpha \mathcal{H}\left\lbrace f_1(x,y)\right\lbrace + \beta \mathcal{H}\left\lbrace f_2(x,y)\right\lbrace,
\end{equation}
...
\begin{eqnarray}
g(x,y) &=& \mathcal{H}\left\lbrace f(x,y) \right\lbrace + e(x,y) \\
